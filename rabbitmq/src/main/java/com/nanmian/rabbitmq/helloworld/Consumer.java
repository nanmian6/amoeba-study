package com.nanmian.rabbitmq.helloworld;
...
public class Consumer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //s：队列名称ID
        //b：是否持久化，false对应不持久化数据，MQ停掉数据就会丢失
        //b1：是否队列私有化，false则代表所有消费者都可以访问，true代表只有第一次拥有它的消费者才能一直使用，其他消费者不让访问
        //b2：是否自动删除,false代表连接停掉后不自动删除掉这个队列
        //map：null
